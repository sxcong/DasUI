#ifndef FBEENERGYWIDGET_H
#define FBEENERGYWIDGET_H
...
class FbeEnergyWidget : public QWidget
{
    Q_OBJECT

public:
    explicit FbeEnergyWidget(QWidget* parent = nullptr);
