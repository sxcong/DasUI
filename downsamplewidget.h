#ifndef DOWNSAMPLEWIDGET_H
#define DOWNSAMPLEWIDGET_H
...
class DownsampleWidget : public QWidget
{
    Q_OBJECT

public:
    explicit DownsampleWidget(QWidget* parent = nullptr);
...
private:
    ...
    void smoothSegmentBoundaries(QCPColorMapData* mapData, int timeCells, int depthCols,
