#ifndef RATERateCurveView_H
#define RATERateCurveView_H
...
class RateCurveView : public QWidget
{
    Q_OBJECT

public:
    explicit RateCurveView(QWidget *parent = nullptr);
    ~RateCurveView();
public:
    void curveInit();
    //数据处理部分
...
//    AxisRange * m_axisRange = nullptr;
    ...
    int m_type = 0;//0代表温度，1代表振动
    int m_flowRate=0;
};

#endif // RateCurveView_H
